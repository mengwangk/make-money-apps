...
public final class ControlPanelSettingsFragment extends BaseFragment {
	...
	public static ControlPanelSettingsFragment newInstance() {
		return new ControlPanelSettingsFragment();
	}
	...
	public void onActivityCreated(final Bundle savedInstanceState) {
		...
		FragmentPagerAdapter adapter = new ControlPanelPageViewerTabsAdapter(getChildFragmentManager());
