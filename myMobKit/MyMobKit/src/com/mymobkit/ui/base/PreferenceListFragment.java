...
public class PreferenceListFragment extends ListFragment {
	...
	public void onCreate(Bundle b) {
		...
		if (b != null)
			xmlId = b.getInt("xml");
		preferenceManager = onCreatePreferenceManager();
	...
	private void postBindPreferences() {
		if (handler.hasMessages(MSG_BIND_PREFERENCES))
			return;
	...
	public void addPreferencesFromResource(int preferencesResId) {
		try {
			...
			m.setAccessible(true);
			PreferenceScreen prefScreen = (PreferenceScreen) m.invoke(preferenceManager, getActivity(), preferencesResId, getPreferenceScreen());
