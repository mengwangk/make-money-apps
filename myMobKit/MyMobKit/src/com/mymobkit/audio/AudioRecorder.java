...
{
	private static final String TAG = AppConfig.LOG_TAG_APP + ":AudioRecorder";
	 ...
	 * 
	 */
	public AudioRecorder(boolean uncompressed, int audioSource, int sampleRate, int channelConfig,
			int audioFormat)
	{
		try
		{
