...
public abstract class ModelBase {
	 ...
	 * Logger instance.
	 */
	protected static final Logger logger = Logger.getLogger(ModelBase.class.getName());
	...
	public static <T extends ModelBase> boolean find(final T model, final String key) {
		...
		try {
			...
			logger.info("Entity not found for " + key);
		}
		return false;
	}
	...
	public static <T extends ModelBase> T fromEntity(Entity entity, Class<T> clazz){
		try {
			...
			logger.log(Level.WARNING, "Error instantiating", e);
		}
		return null;
	}
