...
function initialize() {
	...
	console.log('Requesting TURN if required');
	maybeRequestTurn();
...
function maybeRequestTurn() {
	...
	console.log("TURN server: " + iceServer);
	if (iceServer !== null) {
...
function createPeerConnection() {
	try {
		...
		console.log('PC constraints: ' + JSON.stringify(pcConstraints));
...
function setLocalAndSendMessage(sessionDescription) {
	...
	pc.setLocalDescription(sessionDescription, onSetSessionDescriptionSuccess,
...
function transitionToWaiting() {
	...
	console.log('Transition to waiting');
	resetStatus();
}
