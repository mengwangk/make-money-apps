...
public final class HttpRequestHelper {
   ...
   private static final String CLASS_TAG = HttpRequestHelper.class.getSimpleName();
   ...
   private void performRequest(final String contentType, final String url, final String user, final String pass,
      ...
      Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " making HTTP request to url - " + url);

      // add user and pass to client credentials if present
      if ((user != null) && (pass != null)) {
         Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " user and pass present, adding credentials to request");
            ...
            public void process(final HttpRequest request, final HttpContext context) throws HttpException, IOException {
               for (String key : sendHeaders.keySet()) {
                  if (!request.containsHeader(key)) {
                     Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " adding header: " + key + " | "
                              + sendHeaders.get(key));
      ...
      if (requestType == HttpRequestHelper.POST_TYPE) {
         Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " performRequest POST");
         ...
         if ((params != null) && (params.size() > 0)) {
            ...
            for (String key : params.keySet()) {
               Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " adding param: " + key + " | " + params.get(key));
         ...
         if (nvps != null) {
            try {
               ...
               Log.e(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG, e);
            }
         }
         execute(client, method);
      } else if (requestType == HttpRequestHelper.GET_TYPE) {
         Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " performRequest GET");
   ...
   private void execute(HttpClient client, HttpRequestBase method) {
      Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " execute invoked");
      ...
      try {
         ...
         Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " request completed");
      } catch (Exception e) {
         Log.e(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG, e);
         ...
         try {
            ...
            Log.e(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG, ex);
         }
      }
   }
   ...
   public static ResponseHandler<String> getResponseHandlerInstance(final Handler handler) {
      final ResponseHandler<String> responseHandler = new ResponseHandler<String>() {
         ...
         public String handleResponse(final HttpResponse response) {
            ...
            Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " statusCode - " + status.getStatusCode());
            Log.d(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " statusReasonPhrase - " + status.getReasonPhrase());
            ...
            if (entity != null) {
               ...
               Log.w(CLASS_TAG, " " + HttpRequestHelper.CLASS_TAG + " empty response entity, HTTP error occurred");
