...
import com.smsspeaker.StartMenuActivity;
...
public class DbOpenHelper extends SQLiteOpenHelper {
	...
	private static void initialize(Context context, String databaseName,
		...
		if (instance == null) {
			...
			Log.i(CLASS_TAG, "Try to create instance of database ("
					+ databaseName + ")");
			...
			Log.i(CLASS_TAG, "instance of database (" + databaseName
					+ ") created !");
		}
	}
	...
	private static void copyDataBase(Context aContext, String databaseName)
		...
		Log.i(CLASS_TAG, "Check if create dir : "
	...
	public static boolean checkDatabase(Context aContext, String databaseName) {
		...
		try {
			...
			Log.i(CLASS_TAG, "Database " + databaseName
					+ " does not exists!");
